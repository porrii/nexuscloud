...
- **Snapshots (§17)**: Windows/VSS, Linux/ZFS y Linux/Btrfs ya implementados (ver sección Snapshots arriba) -- los tres adaptadores previstos para este slice están completos.
